...
const PAGE_URL = `${productConfig.siteUrl}/english-quote-log/`;
...
export async function GET() {
  ...
  html = injectPlutoNavigation(html.replaceAll(OLD_PAGE_URL, PAGE_URL));
...
export function injectPlutoNavigation(html: string) {
  ...
  <header class="pluto-site-header" data-${HEADER_MARKER}>
    <div class="pluto-site-header-shell">
      <a class="pluto-brand-lockup" href="${productConfig.siteUrl}/zh/" aria-label="虾子曰">
        <img class="pluto-brand-logo" src="${productConfig.siteUrl}/brand/logo/xiazi-global-hot-topics.webp" alt="虾子曰" width="92" height="92" />
      </a>
      <div class="pluto-header-right">
        <nav class="pluto-header-nav" aria-label="Primary navigation">
          <a href="${productConfig.siteUrl}/zh/#stories">昨日世界</a>
          <a href="${productConfig.siteUrl}/zh/#archive">往期归档</a>
          <a href="${productConfig.siteUrl}/english-quote-log/" aria-current="page">英语句子</a>
          <a href="${productConfig.siteUrl}/zh/#about">关于我们</a>
        </nav>
        <a class="pluto-language-switcher" aria-label="Switch to English" href="${productConfig.siteUrl}/en/">
