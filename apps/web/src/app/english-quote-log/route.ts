...
const XIAZI_PAGE_URL = "https://xiazishuo.com/english-quote-log/";
...
export async function GET() {
  ...
  html = injectXiaziNavigation(html.replaceAll(OLD_PAGE_URL, XIAZI_PAGE_URL));
...
export function injectXiaziNavigation(html: string) {
