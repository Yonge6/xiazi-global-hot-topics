      ...
      <article>
        ...
        {isZh ? (
          <>
            ...
            <p>如你订阅 iOS App 的去广告服务，购买、续订、免费试用、退款与付款信息均由 Apple 处理；虾子曰只读取 Apple 提供的有效订阅权益，用于决定是否在 App 内展示广告，不保存银行卡或付款凭据。</p>
            <h2>外部链接与分享</h2>
          ...
          <>
            ...
            <p>If you subscribe to the iOS app&rsquo;s ad-free service, Apple handles purchases, renewals, free trials, refunds, and payment information. Xiazi Says reads only the active subscription entitlement supplied by Apple to decide whether ads should appear in the app and does not store card or payment credentials.</p>
