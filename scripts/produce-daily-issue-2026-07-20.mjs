...
const base = JSON.parse(
  await fs.readFile(path.join(root, "data/archive/2026-07-19.json"), "utf8"),
);
...
const issue = {
  ...
  slug: issueDate,
  issueDate,
  assetVersion: `issue-${issueDate}-style-atlas-098-image2-v1`,
  status: "published",
  slotHour: 5,
  beijingTimestamp: `${issueDate}T05:00:00+08:00`,
  gmtTimestamp: "2026-07-19T21:00:00Z",
  featuredTopicId: topics[0].id,
  style: {
    name: "Style Atlas #98 Scientific Illustration",
    zhName: "Style Atlas #98 科学插画风格",
    description:
      "Sunny premium scientific editorial illustration with warm ivory paper, precise ink lines, navy and terracotta accents, specimen-like diagrams and clear hierarchy.",
  },
  topics,
};
