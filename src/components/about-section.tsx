        ...
        <div className="about-copy">
          {isZh ? (
            <>
              ...
              <p>所以，我们做了「虾子曰」。每天北京时间05:00，从全球新闻里筛出最新且最值得关注的9件事：先把事实讲清楚，再把门道说明白，配上简短介绍、推荐阅读和可以保存分享的中英文海报。</p>
              ...
              <figure className="contact-qr">
                <img src="/brand/contact-qr.webp" alt="扫码添加微信，联系合作、交流、沟通和学习" />
                <figcaption>扫码加我，合作/交流/学习</figcaption>
              </figure>
            </>
          ) : (
            <>
              ...
              <figure className="contact-qr">
                <img src="/brand/contact-qr.webp" alt="Scan the QR code to connect on WeChat for collaboration and learning" />
                <figcaption>Scan to connect for collaboration, conversation, and learning.</figcaption>
              </figure>
            </>
          )}
        </div>
