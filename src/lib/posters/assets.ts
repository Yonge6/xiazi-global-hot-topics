export const POSTER_ASSET_NAMES = [
  ...
  "world-cup-england-argentina-semifinal",
  "apple-intelligence-china-registration",
  "opc-stripe-atlas-solo-founders",
  "us-iran-blockade-strikes-july15",
  "us-brazil-tariffs-july15",
  "uk-starmer-final-pmqs",
  "pjm-grid-heat-alerts",
  "germany-energy-relief-2027",
  "world-cup-argentina-england-semifinal",
  "waico-29-country-ai-body",
  "opc-altshare-solo-founders-q2",
  "iran-houthi-red-sea-threat",
  "ukraine-fedorov-protests-koretskyi-pm",
  "tsmc-q2-us-investment",
  "texas-guadalupe-flood-wave",
  "rohingya-myanmar-shipwrecks",
  "world-cup-final-rest-day",
  "opc-stripe-atlas-solo-founders",
  "us-iran-hormuz-sixth-night",
  "ukraine-koretskyi-prime-minister",
  "ai-data-center-backlash-michigan",
  "italy-electoral-reform-42-percent",
  "ecb-september-hike-oil-rebound",
] as const;
